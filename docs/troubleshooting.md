...
6. Если используете Happ, проверьте настройки приложения и отключите лишние ползунки (или используйте другое приложение, например, v2RayTun). Если принципиально использование Happ, используйте кнопку сброса в настройках приложения (нужно будет заново добавлять ссылки).
