...
* 90 дней — 285 рублей.
* 180 дней — 540 рублей.
* 365 дней — 1050 рублей.

В боте доступны быстрые варианты на 30, 90, 180 и 365 дней. Кнопка «Ввести своё число» позволяет выбрать любой срок от
30 до 3650 дней. Цена рассчитывается автоматически с учётом скидки за объём; например, срок на 60 дней стоит 190 рублей.
...
При увеличении оплачиваются только новые места по прогрессивной шкале:

* четвёртое устройство — 100 рублей;
* пятое — 150 рублей;
* шестое — 200 рублей;
* седьмое и каждое последующее — 250 рублей.
